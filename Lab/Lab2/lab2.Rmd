...
```{r}
setwd("~/Dropbox (University of Oregon)/EC320--Ren--2022/EC320/EC320/Lab") # commented out so it doesn't run this line!
...
```{r}
our_data <- read_csv("Lab/Lab2/Lab2.csv") # this should read after changing to the appropriate wd using setwd() above
```
