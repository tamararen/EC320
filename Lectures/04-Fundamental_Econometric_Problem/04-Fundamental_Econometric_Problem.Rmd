...
pagedown::chrome_print("04-Fundamental_Econometric_Problem.html",output="04-Fundamental_Econometric_Problem.pdf")
...
# Notes directory
dir_slides <- "/EC320/Lectures/04-Fundamental_Econometric_Problem"
```
...
geom_tile(data = med_df2, aes(fill = q), color = "white", size = 0.2) +
