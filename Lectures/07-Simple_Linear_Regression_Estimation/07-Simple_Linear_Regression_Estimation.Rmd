...
pagedown::chrome_print("07-Simple_Linear_Regression_Estimation.html",output="07-Simple_Linear_Regression_Estimation.pdf")

library(pacman)
p_load(ggthemes, viridis, knitr, extrafont, tidyverse, magrittr, wooldridge,xaringanthemer)
# Data 
...
1. Learn the mechanics of OLS

2. Interpret regression results

3. Extend ideas about causality to a regression context

4. Lay foundation for more sophisticated regression techniques 
---
