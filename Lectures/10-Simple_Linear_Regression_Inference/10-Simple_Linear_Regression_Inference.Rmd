...
library(pacman)
p_load(ggthemes, viridis, knitr, extrafont, tidyverse, magrittr, wooldridge, stargazer, latex2exp, parallel, broom, wooldridge,xaringanthemer)
# Define colors
red_pink <- "#e64173"
...
library(pagedown)
pagedown::chrome_print("10-Simple_Linear_Regression_Inference.html", output = "10-Simple_Linear_Regression_Inference.pdf")
```

---
# Hypothesis testing 

Use the sampling distribution of $\hat{\beta}$ to conduct hypothesis tests.

- Can use all classical assumptions to show that OLS is normally distributed:
