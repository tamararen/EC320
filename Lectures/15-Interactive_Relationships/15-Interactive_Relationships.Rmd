...
library(pagedown)
pagedown::chrome_print("15-Interactive_Relationships.html", output = "15-Interactive_Relationships.pdf")
```
...
```{R, int plot 1, echo = F, fig.height = 5.5}
...
```{R, int plot 2, echo = F, fig.height = 5.5}
ggplot(data = int_df, aes(x = school, y = pay)) +
geom_point(aes(color = male, shape = male), size = 2.5) +
geom_hline(yintercept = 0, color = met_slate) +
geom_vline(xintercept = 0, color = met_slate) +
