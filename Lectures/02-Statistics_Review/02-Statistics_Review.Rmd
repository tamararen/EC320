...
to_pdf("02-Statistics_Review.RMD")
...
theme_simple <- theme_bw() + theme(
  ...
  text = element_text(family = "Fira Sans", color = "dark gray", size = 14),
...
ggplot() +
  ...
  scale_y_continuous(limits = c(0, 1), expand=c(0,0), breaks = c(0, 0.5, 1), labels = c(0, 0.5, 1)) +
  geom_ribbon(aes(x = z, ymin = 0, ymax = 0.5), fill = "grey85", linetype = "blank") +
  geom_ribbon(aes(x = y, ymin = 0, ymax = 0.5), fill = "dark red", linetype = "blank") +
  geom_vline(xintercept = 1, size = 0.35, linetype = "dashed", color = "dark gray") +
  geom_vline(xintercept = 1.5, size = 0.35, linetype = "dashed", color = "dark gray") +
  xlab(expression(X)) + 
...
ggplot() +
  ...
  #geom_polygon(data = df %>% filter(x <= qnorm(0.5 + 0.475) & x >= qnorm(0.5 - 0.475)), aes(x, y), fill = "dark red") +
  #geom_vline(xintercept = qnorm(0.5 + 0.475), size = 0.35, linetype = "dashed", color = "dark gray") +
  #geom_vline(xintercept = qnorm(0.5 - 0.475), size = 0.35, linetype = "dashed", color = "dark gray") +
  xlab(expression(X)) + 
  ylab("Density")
```
...
ggplot() +
  ...
  scale_y_continuous(limits = c(0, 0.5), expand=c(0,0), breaks = c(0, 0.5), labels = c(0, 0.5)) +
  geom_polygon(data = df, aes(x, y), fill = "grey85") +
  geom_vline(xintercept = 0, color = "dark red", size = 1) +
  #geom_polygon(data = df %>% filter(x <= qnorm(0.5 + 0.475) & x >= qnorm(0.5 - 0.475)), aes(x, y), fill = "dark red") +
  #geom_vline(xintercept = qnorm(0.5 + 0.475), size = 0.35, linetype = "dashed", color = "dark gray") +
  #geom_vline(xintercept = qnorm(0.5 - 0.475), size = 0.35, linetype = "dashed", color = "dark gray") +
  xlab(expression(X)) + 
...
df <- tibble(x = rnorm(100, 5, 5),
             y = 1 + 3*x)
ggplot() +
  geom_point(data = df, aes(x, y), color = "dark red") +
  xlab(expression(X)) + 
  ylab(expression(Y))
```
