...
library(pacman)
p_load(ggthemes, viridis, knitr, AER, extrafont, tidyverse, magrittr, wooldridge, stargazer, latex2exp, parallel, broom, kableExtra, ggforce, margins, furrr, gapminder,xaringanthemer)
# Define colors
red_pink <- "#e64173"
turquoise <- "#20B2AA"
orange <- "#FFA500"
...
library(pagedown)
pagedown::chrome_print("16-Nonlinear_Relationships.html", output = "16-Nonlinear_Relationships.pdf")
...
Review lecture tomorrow --- with practice questions. 

- Come prepared with questions.

**Exam:** Friday, July 15 at 12 pm PST 

Office hours Thursday from 6-8 pm 
...
```{R, log linear plot, echo = F, cache = T, fig.height = 6}
# Plot
...
```{R, log linear plot 2, echo = F, cache = T, fig.height = 6}
# Plot
...
```{R, log log plot 2, echo = F, cache = T, fig.height = 6}
# Plot
...
```{R, linear log plot, echo = F, cache = T, fig.height = 6}
# Plot
...
```{R, linear log plot 2, echo = F, cache = T, fig.height = 6}
# Plot
...
.pull-left[
```{R, skew 1, echo = F, cache = T, fig.height = 5}
# Plot
...
.pull-right[
```{R, skew 2, echo = F, cache = T, fig.height = 5}
# Plot
...
```{R, quad plot, echo = F, cache = T, fig.height = 6.75}
# Set seed
set.seed(1234)
# Sample size
n <- 1e3
